...
class MainActivity : ComponentActivity() {
    ...
    private fun handleStressTestMode() {
        ...
        // Brief delay then continue to next activity
        Handler(Looper.getMainLooper()).postDelayed({
            ...
            if (nextActivityIndex < 3) {
                // Continue to next activity in this cycle
                val targetClass = when (nextActivityIndex) {
                    1 -> SecondActivity::class.java
                    2 -> ThirdActivity::class.java
                    else -> null
                }
                targetClass?.let {
                    val nextIntent = Intent(this, it).apply {
                ...
                if (nextCycle <= total) {
                    ...
                    // All cycles completed - return to stress test screen
